...
public class www {
    ...
    public static void setImageMarkOptions(float alpha , int positionWidth , int positionHeight ,Font font,Color color){
        if(alpha!=0.0f)www.alpha = alpha;
        if(positionWidth!=0)www.positionWidth = positionWidth;
        if(positionHeight!=0)www.positionHeight = positionHeight;
        if(font!=null)www.font = font;
        if(color!=null)www.color = color;
    }
    ...
    public static void main(String [] args){
        String srcImgPath = "/home/zx/zhuo.jpg";  
        String logoText = "[ I love Qie]";
       // String iconPath = "/home/zx/zhuo.jpg";  
         
        String targerTextPath = "/home/zx/javaDemo/zhh.jpg";  
